...
def compute_metrics(input_model_output,  gold_standard, challenges, participant_name, community, out_path):
    ...
    ALL_ASSESSMENTS = []
    assessment_data = {'participant': participant_name, 'Overall Accuracy': overall_accuracy, 'Statistical Parity': statistical_parity, 
                       'Equal Opportunity': equal_opportunity, 'Predictive Equality': predictive_equality, 'False Negative Rate': false_negative_rate,
                       'Disparate Impact': DI, 'Accuracy Difference': AD, 'Difference in Conditional Acceptance': DCA, 'Difference in Conditional Rejection': DCR, 'Treatment Equality': TE}
